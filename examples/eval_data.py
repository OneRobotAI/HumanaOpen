...
def main():
    ...
    # ── Keyboard (pynput toggle — press e to switch, q to quit) ──────
    ...
    listener.start()
    print("  Keyboard: press e=toggle override, q=quit")
    ...
    try:
        for ep in range(d["num_episodes"]):
            ...
            print("  Policy control active" if has_teleop else "  Running inference...")
